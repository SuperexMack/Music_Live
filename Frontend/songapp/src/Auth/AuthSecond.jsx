        ...
        <>
            <div className="h-screen w-full flex justify-center items-center px-4 sm:px-0">
                <div className="rounded-lg h-auto sm:h-[700px] w-full sm:w-[500px] flex flex-col items-center space-y-6 sm:space-y-10 p-4 sm:p-0">
                    <p className="text-[30px] sm:text-[40px] font-bold mt-10 sm:mt-20 text-center">User Login</p>
                    <input placeholder="Enter Your Email" className={property} />
                    <input placeholder="Enter your Phone Number" className={property} />
                    <input placeholder="Enter your Password" className={property} />
                    <div className="space-y-4 text-[16px] sm:text-[20px] font-bold flex flex-col items-center sm:items-stretch w-full">
                        <button onClick={changeClient} className="p-3 sm:p-4 bg-green-600 rounded-lg text-white auth-buttons w-full">Don't have an account?</button>
                    </div>
